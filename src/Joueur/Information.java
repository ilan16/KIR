...
public class Information {
    ...
    public Information(String nom, String prenom, String adresse, String dateNaissance, boolean sexe, String tel, String pseudo, String mail, int score, int nv, int nbconnecte) {
        this.nom = nom;
        this.prenom = prenom;
